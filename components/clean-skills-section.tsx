...
import { StreamlinedSkills } from "@/components/streamlined-skills"

export function CleanSkillsSection() {
  return (
    <section
      id="skills"
      className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-alice_blue-900 via-periwinkle-900 to-lavender-900 relative overflow-hidden"
    >
      {/* Decorative Elements */}
